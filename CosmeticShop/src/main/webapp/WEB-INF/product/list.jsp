                                    ...
                                    <table class="table table-editable table-nowrap">
                                        ...
                                        <c:forEach items="${requestScope.productList}" var="product">
                                            <tr>
                                                ...
                                                <th><c:out value="${product.getproductName()}"/></th>
                                                <th><c:out value="${product.getPrice()}"/></th>
                                                <th><c:out value="${product.getQuantity()}"/></th>
<%--                                                <th><c:out value="${product.getImage()}"/></th>--%>
                                                <td class="align-middle"><img src="${product.getImage()}" alt=""
                                                                              width="150"
                                                                              height="150" style="border-radius:10px"></td>
                                                <th><c:out value="${product.getCreateDate()}"/></th>
                                                <th><c:out value="${product.getUpdateDate()}"/></th>
                                                <th>
                                                    <a href="/product?action=update&id=${product.getProductId()}">Update</a>
